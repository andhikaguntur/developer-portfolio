        ...
        <div className="bg-background border border-border/50 rounded-xl p-4 md:p-6 hover:border-border transition-colors shadow-sm">
            <div className="flex flex-col md:flex-row gap-4">
                <div className="shrink-0">
                    <div className="w-12 h-12 rounded-lg bg-muted overflow-hidden flex items-center justify-center border border-border relative">
                        <Image src={logo} alt={company} fill unoptimized className="object-cover" />
                    </div>
                </div>
    ...
    return (
        <div className="bg-background border border-border/50 rounded-xl p-4 md:p-6 hover:border-border transition-colors shadow-sm">
            <div className="flex flex-col md:flex-row gap-4">
                <div className="shrink-0">
                    <div className="w-12 h-12 rounded-lg bg-muted overflow-hidden flex items-center justify-center border border-border relative">
                        <Image src={logo} alt={school} fill unoptimized className="object-cover" />
                    </div>
                </div>
                <div className="flex-1">
                    <div>
